...
I_value_ch1_hsize=3*I_value_ch1_sigma;
I_value_ch2_hsize=3*I_value_ch2_sigma;
Q_value_ch1_hsize=3*Q_value_ch1_sigma;
Q_value_ch2_hsize=3*Q_value_ch2_sigma;

I_value_ch1_gausFilter = fspecial('gaussian',I_value_ch1_hsize,I_value_ch1_sigma);
I_value_ch2_gausFilter = fspecial('gaussian',I_value_ch2_hsize,I_value_ch2_sigma);
Q_value_ch1_gausFilter = fspecial('gaussian',Q_value_ch1_hsize,Q_value_ch1_sigma);
Q_value_ch2_gausFilter = fspecial('gaussian',Q_value_ch2_hsize,Q_value_ch2_sigma);

I_value_ch1_reconstructed=imfilter(I_value_ch1,I_value_ch1_gausFilter,'replicate');
I_value_ch2_reconstructed=imfilter(I_value_ch2,I_value_ch2_gausFilter,'replicate');
Q_value_ch1_reconstructed=imfilter(Q_value_ch1,Q_value_ch1_gausFilter,'replicate');
Q_value_ch2_reconstructed=imfilter(Q_value_ch2,Q_value_ch2_gausFilter,'replicate');

% 
% [I_value_ch1_Phi,I_value_ch1_A,I_value_ch1_reconstructed]=denoiseKSVDNN(I_value_ch1,SNRdB_I,param);
% 
